...
public class SquareAnnotHandler implements AnnotHandler {
        ...
        if (annot != null) {
            try {
                if (ToolUtil.getCurrentAnnotHandler(uiExtensionsManager) == this && ((long) color) != annot.getBorderColor()) {
                    modifyAnnot(annot.getPage().getIndex(), annot, annot.getRect(), color, (int) (((Square) annot).getOpacity() * 255.0f), annot.getBorderInfo().getWidth(), annot.getContent(), false, false, null);
                }
    ...
    public void onOpacityValueChanged(int opacity) {
        ...
        if (annot != null) {
            try {
                if (ToolUtil.getCurrentAnnotHandler(uiExtensionsManager) == this && opacity != ((int) (((Square) annot).getOpacity() * 255.0f))) {
        ...
        if (annot != null) {
            try {
                if (ToolUtil.getCurrentAnnotHandler(uiExtensionsManager) == this && lineWidth != annot.getBorderInfo().getWidth()) {
                    ...
                    modifyAnnot(annot.getPage().getIndex(), annot, annot.getRect(), (int) annot.getBorderColor(), (int) (((Square) annot).getOpacity() * 255.0f), lineWidth, annot.getContent(), false, false, null);
    ...
    private void modifyAnnot(int pageIndex, Annot annot, RectF bbox, int color, int opacity, float lineWidth, String contents, boolean isModifyJni, boolean addUndo, Callback result) {
        final SquareModifyUndoItem undoItem = new SquareModifyUndoItem(this.mPdfViewCtrl);
        ...
        if (isModifyJni) {
            ...
            this.mPdfViewCtrl.addTask(new EditAnnotTask(new SquareEvent(2, undoItem, (Square) annot, this.mPdfViewCtrl), new Callback() {
                public void result(Event event, boolean success) {
                    if (success) {
                        if (z) {
                            DocumentManager.getInstance(SquareAnnotHandler.this.mPdfViewCtrl).addUndoItem(undoItem);
                            DocumentManager.getInstance(SquareAnnotHandler.this.mPdfViewCtrl).setHasModifyTask(false);
                        }
                        RectF tempRectF = SquareAnnotHandler.this.mTempLastBBox;
                        if (SquareAnnotHandler.this.mPdfViewCtrl.isPageVisible(i)) {
                            ...
                            SquareAnnotHandler.this.mPdfViewCtrl.convertPdfRectToPageViewRect(annotRectF, annotRectF, i);
                            SquareAnnotHandler.this.mPdfViewCtrl.convertPdfRectToPageViewRect(tempRectF, tempRectF, i);
                            ...
                            SquareAnnotHandler.this.mPdfViewCtrl.refresh(i, AppDmUtil.rectFToRect(annotRectF));
                        }
                    }
                    if (callback != null) {
        ...
        if (!isModifyJni) {
            ...
            ((Square) annot).setOpacity(((float) opacity) / 255.0f);
    ...
    private void deleteAnnot(Annot annot, boolean addUndo, Callback result) {
        ...
        try {
            ...
            final SquareDeleteUndoItem undoItem = new SquareDeleteUndoItem(this.mPdfViewCtrl);
            undoItem.setCurrentValue(annot);
            undoItem.mPageIndex = pageIndex;
            final boolean z = addUndo;
            final Callback callback = result;
            this.mPdfViewCtrl.addTask(new EditAnnotTask(new SquareEvent(3, undoItem, (Square) annot, this.mPdfViewCtrl), new Callback() {
                public void result(Event event, boolean success) {
                    if (success) {
                        ...
                        if (SquareAnnotHandler.this.mPdfViewCtrl.isPageVisible(pageIndex)) {
                            SquareAnnotHandler.this.mPdfViewCtrl.convertPdfRectToPageViewRect(viewRect, viewRect, pageIndex);
                            SquareAnnotHandler.this.mPdfViewCtrl.refresh(pageIndex, AppDmUtil.rectFToRect(viewRect));
                        }
                    }
                    if (callback != null) {
                        callback.result(null, success);
    ...
    public void onAnnotDeselected(Annot annot, boolean needInvalid) {
        ...
        try {
            ...
            if (needInvalid && this.mIsModify) {
                if (this.mTempLastColor == ((int) annot.getBorderColor()) && this.mTempLastLineWidth == annot.getBorderInfo().getWidth() && this.mTempLastBBox.equals(annot.getRect()) && this.mTempLastOpacity == ((int) (((Square) annot).getOpacity() * 255.0f))) {
                    modifyAnnot(page.getIndex(), annot, annot.getRect(), (int) annot.getBorderColor(), (int) (((Square) annot).getOpacity() * 255.0f), annot.getBorderInfo().getWidth(), annot.getContent(), false, false, null);
                } else {
                    modifyAnnot(page.getIndex(), annot, annot.getRect(), (int) annot.getBorderColor(), (int) (((Square) annot).getOpacity() * 255.0f), annot.getBorderInfo().getWidth(), annot.getContent(), true, true, null);
                }
                ...
                annot.setBorderInfo(borderInfo);
                ((Square) annot).setOpacity(((float) this.mTempLastOpacity) / 255.0f);
    ...
    private void prepareAnnotMenu(final Annot annot) {
        ...
        this.mAnnotationMenu.setListener(new ClickListener() {
            public void onAMClick(int btType) {
                if (btType == 2) {
                    if (annot == DocumentManager.getInstance(SquareAnnotHandler.this.mPdfViewCtrl).getCurrentAnnot()) {
                        SquareAnnotHandler.this.deleteAnnot(annot, true, null);
                    }
                } else if (btType == 3) {
                    DocumentManager.getInstance(SquareAnnotHandler.this.mPdfViewCtrl).setCurrentAnnot(null);
                    UIAnnotReply.showComments(SquareAnnotHandler.this.mContext, SquareAnnotHandler.this.mPdfViewCtrl, SquareAnnotHandler.this.mParent, annot);
                } else if (btType == 4) {
                    DocumentManager.getInstance(SquareAnnotHandler.this.mPdfViewCtrl).setCurrentAnnot(null);
                    UIAnnotReply.replyToAnnot(SquareAnnotHandler.this.mContext, SquareAnnotHandler.this.mPdfViewCtrl, SquareAnnotHandler.this.mParent, annot);
                } else if (btType == 6) {
                    SquareAnnotHandler.this.mAnnotationProperty.show(SquareAnnotHandler.this.mDocViewerBBox, false);
    ...
    private void preparePropertyBar() {
        ...
        try {
            ...
            this.mAnnotationProperty.setProperty(2, AppDmUtil.opacity255To100((int) ((((Square) DocumentManager.getInstance(this.mPdfViewCtrl).getCurrentAnnot()).getOpacity() * 255.0f) + 0.5f)));
    ...
    public void addAnnot(int pageIndex, AnnotContent contentSupplier, boolean addUndo, Callback result) {
        try {
            ...
            final int i = pageIndex;
            final Callback callback = result;
            this.mPdfViewCtrl.addTask(new EditAnnotTask(new SquareEvent(1, undoItem, (Square) annot, this.mPdfViewCtrl), new Callback() {
                public void result(Event event, boolean success) {
                    if (success) {
                        DocumentManager.getInstance(SquareAnnotHandler.this.mPdfViewCtrl).onAnnotAdded(page, annot);
                        if (z) {
                            DocumentManager.getInstance(SquareAnnotHandler.this.mPdfViewCtrl).addUndoItem(undoItem);
                        }
                        if (SquareAnnotHandler.this.mPdfViewCtrl.isPageVisible(i)) {
                            try {
                                ...
                                SquareAnnotHandler.this.mPdfViewCtrl.convertPdfRectToPageViewRect(viewRect, viewRect, i);
                                Rect rect = new Rect();
            ...
            case 3:
                if (this.mTouchCaptured && annot == DocumentManager.getInstance(this.mPdfViewCtrl).getCurrentAnnot() && pageIndex == annot.getPage().getIndex()) {
                    ...
                    if (this.mLastOper == -1 || this.mDownPoint.equals(this.mLastPoint.x, this.mLastPoint.y)) {
                        ...
                        _lineWidth = annot.getBorderInfo().getWidth();
                        rectF.inset((-thicknessOnPageView(pageIndex, _lineWidth)) / 2.0f, (-thicknessOnPageView(pageIndex, _lineWidth)) / 2.0f);
                        RectF bboxRect = new RectF(rectF);
                        this.mPdfViewCtrl.convertPageViewRectToPdfRect(bboxRect, bboxRect, pageIndex);
                        modifyAnnot(pageIndex, annot, bboxRect, (int) annot.getBorderColor(), (int) (((Square) annot).getOpacity() * 255.0f), _lineWidth, annot.getContent(), false, false, null);
                        this.mPdfViewCtrl.convertPageViewRectToDisplayViewRect(rectF, rectF, pageIndex);
                        if (!this.mIsEditProperty) {
                            if (this.mAnnotationMenu.isShowing()) {
                                this.mAnnotationMenu.update(rectF);
        ...
        if (annot != null && (annot instanceof Square)) {
            try {
                ...
                if (this.mBitmapAnnot == annot && annotPageIndex == pageIndex) {
                    ...
                    this.mPathPaint.setAlpha((int) (((Square) annot).getOpacity() * 255.0f));
