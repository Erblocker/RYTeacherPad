...
import com.netspace.library.components.VideoChatComponent;
...
public class VideoChatWindow extends StandOutWindow implements ComponentCallBack {
    private HashMap<Integer, String> mMapVideoURI = new HashMap();
    private HashMap<Integer, VideoChatComponent> mMapView = new HashMap();
    ...
    public void createAndAttachView(int id, FrameLayout frame) {
        ...
        VideoChatComponent VideoChatComponent = new VideoChatComponent(this);
        frame.addView(VideoChatComponent);
        VideoChatComponent.setTag(Integer.valueOf(id));
        VideoChatComponent.setCallBack(this);
        this.mMapView.put(Integer.valueOf(id), VideoChatComponent);
    }
    ...
    public void onReceiveData(int id, int requestCode, Bundle data, Class<? extends StandOutWindow> cls, int fromId) {
        VideoChatComponent VideoChatComponent = (VideoChatComponent) this.mMapView.get(Integer.valueOf(id));
        if (data.getString("data") == null) {
            String changedText = data.getString("uri");
            if (changedText != null) {
                new Intent().setData(Uri.parse(changedText));
            }
    ...
    public Intent getPersistentNotificationIntent(int id) {
        return StandOutWindow.getCloseIntent(this, VideoChatWindow.class, id);
    }
