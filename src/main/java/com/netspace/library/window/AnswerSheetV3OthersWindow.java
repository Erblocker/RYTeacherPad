...
public class AnswerSheetV3OthersWindow extends StandOutWindow implements ComponentCallBack {
    private HashMap<Integer, String> mMapCameraURI = new HashMap();
    private HashMap<Integer, AnswerSheetV3OthersComponent> mMapRootView = new HashMap();
    ...
    public void createAndAttachView(int id, FrameLayout frame) {
        ...
        AnswerSheetV3OthersComponent CameraComponent = new AnswerSheetV3OthersComponent(this);
    ...
    public Intent getPersistentNotificationIntent(int id) {
        return StandOutWindow.getCloseIntent(this, AnswerSheetV3OthersWindow.class, id);
    }
    ...
    public void onReceiveData(int id, int requestCode, Bundle data, Class<? extends StandOutWindow> cls, int fromId) {
        AnswerSheetV3OthersComponent AnswerSheetV3OthersComponent = (AnswerSheetV3OthersComponent) this.mMapRootView.get(Integer.valueOf(id));
        if (AnswerSheetV3OthersComponent != null) {
            String szData = data.getString("data");
            if (szData != null) {
                AnswerSheetV3OthersComponent.setData(szData);
                return;
            }
            ...
            if (changedText != null) {
                ...
                AnswerSheetV3OthersComponent.intentComplete(intent);
            }
            if (data.getBoolean("lock")) {
                AnswerSheetV3OthersComponent.setLocked(true);
            }
        }
    }
