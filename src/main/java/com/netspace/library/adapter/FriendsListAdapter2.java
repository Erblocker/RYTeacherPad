...
public class FriendsListAdapter2 extends BaseExpandableListAdapter {
    ...
    public FriendsListAdapter2(Context context, ListView ListView) {
    ...
    public void add(String szName, String szUID, String szGroupName, boolean bHasNewMessage) {
        ...
        while (i < this.marrData.size()) {
            FriendItem OneItem = (FriendItem) this.marrData.get(i);
            if (!OneItem.szUID.equalsIgnoreCase(szUID) || !OneItem.szGroupName.equalsIgnoreCase(szGroupName)) {
                i++;
            } else {
                return;
            }
    ...
    public void addToTop(String szName, String szUID, String szGroupName, boolean bHasNewMessage) {
        FriendItem NewItem = new FriendItem();
        int i = 0;
        while (i < this.marrData.size()) {
            FriendItem OneItem = (FriendItem) this.marrData.get(i);
    ...
    public String getUserRealName(String szUID) {
        for (int i = 0; i < this.marrData.size(); i++) {
            if (((FriendItem) this.marrData.get(i)).szUID.equalsIgnoreCase(szUID)) {
                return ((FriendItem) this.marrData.get(i)).szName;
            }
        }
        return null;
    }
    ...
    public void updateBackgroundKey(String szSender2, String szBoardBackgroundKey) {
        for (int i = 0; i < this.marrData.size(); i++) {
            if (((FriendItem) this.marrData.get(i)).szUID.equalsIgnoreCase(szSender2)) {
                ((FriendItem) this.marrData.get(i)).szDrawPadBackground = szBoardBackgroundKey;
            }
        }
    }
}
