...
public class QuestionCaptureGetTypeDialog extends Dialog implements OnClickListener {
    private int mOptions = 0;
    private String mszCorrectAnswer = "";
    private String mszQuestionType = "";

    public QuestionCaptureGetTypeDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("试题类型");
        setContentView(R.layout.dialog_questiontype);
        ...
        radgrp.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                TextView AnswerView = (TextView) QuestionCaptureGetTypeDialog.this.findViewById(R.id.editTextCorrectAnswer);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.buttonOk) {
            ...
            dismiss();
        } else if (v.getId() == R.id.radioButton5) {
            this.mszQuestionType = "";
            dismiss();
