...
public class ScatterChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    static /* synthetic */ int[] $SWITCH_TABLE$com$github$mikephil$charting$charts$ScatterChart$ScatterShape() {
        ...
        if (iArr == null) {
            iArr = new int[ScatterShape.values().length];
            try {
                iArr[ScatterShape.CIRCLE.ordinal()] = 3;
            } catch (NoSuchFieldError e) {
            }
            try {
                iArr[ScatterShape.CROSS.ordinal()] = 1;
            } catch (NoSuchFieldError e2) {
            }
            try {
                iArr[ScatterShape.SQUARE.ordinal()] = 4;
            } catch (NoSuchFieldError e3) {
            }
            try {
                iArr[ScatterShape.TRIANGLE.ordinal()] = 2;
