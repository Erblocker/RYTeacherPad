...
public class JsonReader implements Closeable {
    ...
    public String toString() {
        return new StringBuilder(String.valueOf(getClass().getSimpleName())).append(locationString()).toString();
    }
    ...
    private IOException syntaxError(String message) throws IOException {
        throw new MalformedJsonException(new StringBuilder(String.valueOf(message)).append(locationString()).toString());
    }
