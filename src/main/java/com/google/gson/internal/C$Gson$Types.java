...
public final class C$Gson$Types {
    ...
    private static Type resolve(Type context, Class<?> contextRawType, Type toResolve, Collection<TypeVariable> visitedTypeVariables) {
        ...
        if ((toResolve instanceof Class) && ((Class) toResolve).isArray()) {
            ...
            Type newOwnerType = C$Gson$Types.resolve(context, contextRawType, ownerType, visitedTypeVariables);
            ...
            if (originalLowerBound.length == 1) {
                Type lowerBound = C$Gson$Types.resolve(context, contextRawType, originalLowerBound[0], visitedTypeVariables);
                ...
                Type upperBound = C$Gson$Types.resolve(context, contextRawType, originalUpperBound[0], visitedTypeVariables);
