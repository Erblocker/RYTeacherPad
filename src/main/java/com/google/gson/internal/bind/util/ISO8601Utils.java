...
public class ISO8601Utils {
    ...
    public static String format(Date date, boolean millis, TimeZone tz) {
        ...
        if (offset != 0) {
            int hours = Math.abs((offset / Const.IM_DEFAULT_TIMEOUT) / 60);
            int minutes = Math.abs((offset / Const.IM_DEFAULT_TIMEOUT) % 60);
    ...
    public static Date parse(String date, ParsePosition pos) throws ParseException {
        ...
        try {
            ...
            if (hasT || date.length() > index) {
                ...
                if (timezoneIndicator == 'Z') {
                    ...
                    if (timezoneOffset.length() < 5) {
                        timezoneOffset = new StringBuilder(String.valueOf(timezoneOffset)).append("00").toString();
                    }
            ...
            fail = e;
            input = date == null ? null : new StringBuilder(String.valueOf('\"')).append(date).append("'").toString();
            msg = fail.getMessage();
