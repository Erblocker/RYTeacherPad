...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new TypeAdapter<BitSet>() {
        ...
        public BitSet read(JsonReader in) throws IOException {
            ...
            while (tokenType != JsonToken.END_ARRAY) {
                boolean set;
                switch (AnonymousClass2.$SWITCH_TABLE$com$google$gson$stream$JsonToken()[tokenType.ordinal()]) {
                    case 6:
    ...
    public static final TypeAdapter<JsonElement> JSON_ELEMENT = new TypeAdapter<JsonElement>() {
        ...
        public JsonElement read(JsonReader in) throws IOException {
            switch (AnonymousClass29.$SWITCH_TABLE$com$google$gson$stream$JsonToken()[in.peek().ordinal()]) {
                case 1:
    ...
    public static final TypeAdapter<Number> NUMBER = new TypeAdapter<Number>() {
        ...
        public Number read(JsonReader in) throws IOException {
            ...
            switch (AnonymousClass14.$SWITCH_TABLE$com$google$gson$stream$JsonToken()[jsonToken.ordinal()]) {
                case 6:
                case 7:
    ...
    class AnonymousClass35 implements TypeAdapterFactory {
        ...
        public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
            ...
            final TypeAdapter typeAdapter = this.val$typeAdapter;
