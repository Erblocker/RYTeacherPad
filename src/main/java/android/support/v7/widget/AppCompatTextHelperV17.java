...
class AppCompatTextHelperV17 extends AppCompatTextHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(0)) {
            this.mDrawableStartTint = AppCompatTextHelper.createTintInfo(context, tintManager, a.getResourceId(0, 0));
        }
        if (a.hasValue(1)) {
            this.mDrawableEndTint = AppCompatTextHelper.createTintInfo(context, tintManager, a.getResourceId(1, 0));
        }
        a.recycle();
    }
